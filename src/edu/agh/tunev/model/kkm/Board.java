...
public class Board {
	...
	public double getPhysics(Point where, Physics what)
		...
		try {
			...
			// jeśli nie ma żadnej komórki na pozycji {@code where}
	...
	public void updateData(double simTime) throws FileNotFoundException,
			ParseException {
		// parser, ty nie czytać danych w tym miejscu! -- m.
		//parser.readData(simTime);
	}

	/** sprawdza, czy punkty znajduje się na planszy */
	...
	/** Czas dla jakiego mamy określone dane dla planszy */
	...
	/**
	 * Ustawia geometrię planszy.
	 * 
	 * @param dimension
	 *            Rozmiar planszy (najdalszy punkt od jej początku).
	 * @param numCellsX
	 *            Rozdzielczość w OX (na ile odcinków dzielimy OX).
	 * @param numCellsY
	 *            Rozdzielczość w OY.
	 */
	...
	// TODO: hardcode do testow, nie chciało mi się na razie robić parsowania
	/*
